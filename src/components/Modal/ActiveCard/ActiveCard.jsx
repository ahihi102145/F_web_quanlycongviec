...
import { singleFileValidator } from '~/utitls/validators'
...
function ActiveCard() {
  ...
  const callApiUpdateCard = async (updateData) =>{
    ...
    //B1:cap nhat lai cai card dang active trong modal hien tai
    dispatch(updateCurrentActiveCard(updatedCard))

    //B2:cap nhat lai ban ghi card trong cai activeBoard (nested data)
