...
import { EMAIL_RULE, FIELD_REQUIRED_MESSAGE, EMAIL_RULE_MESSAGE } from '~/utitls/validators'
...
function InviteBoardUser({boardId}) {
  ...
  */
  ...
  const submitInviteUserToBoard = (data) => {
    ...
    //goi api moi nguoi dung vao lam thanh vien cua board
    inviteUserToBoardAPI({inviteeEmail, boardId}).then(() => {
      // Clear thẻ input sử dụng react-hook-form bằng setValue , đồng thời đóng popover lai
      setValue('inviteeEmail', null)
      setAnchorPopoverElement(null)
    })
    //mời 1 người dùng vào board song thì cũng se gửi mail sự kiện socket lên server(tính năng real-time)
