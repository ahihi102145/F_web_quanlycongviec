...
import {DEFAULT_PAGE, DEFAULT_ITEMS_PER_PAGE} from '~/utitls/constants'
...
function Boards() {
  ...
  useEffect(() => {
    ...
    //moi khi cau url  thay doi vi du nhu chuyen trang , thi cai location.search se lay tu hook useLocation cua reac-router-dom cung thay doi theo ,
    //dong nghia ham useEffect se chay lai va fecth lai API theo dung page moi vi cai location.search da nam trong dependencies cua useEffect
  ...
  const afterCreateNewBoard = () => {
    // don gian la cu fetch  lai danh sach board tuong tu trong useEffect
    fetchBoardsAPI(location.search).then(updateStateData)
