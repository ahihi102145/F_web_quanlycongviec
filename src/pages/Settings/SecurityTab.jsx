...
import { FIELD_REQUIRED_MESSAGE, PASSWORD_RULE, PASSWORD_RULE_MESSAGE } from '~/utitls/validators'
    ...
    confirmChangePassword({
      ...
      toast.promise( dispatch(updateUserAPI({current_password,new_password}) ), { pending :'Updating...'})
            .then(res => {
              ...
              if(!res.error) {
                toast.success('Successfully changged your password,please login again!', { theme: 'colored' })
